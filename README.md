...
[![Copilot coding agent](https://github.com/iliyaqdrwalqu/SiGtRiP/actions/workflows/copilot-swe-agent/copilot/badge.svg)](https://github.com/iliyaqdrwalqu/SiGtRiP/actions/workflows/copilot-swe-agent/copilot)
...
> Последнее обновление: 2026-03-20. Проверено после очистки и реструктуризации репозитория.
...
- ✅ Проверка целостности: `python scripts/health_check.py` (перемещён в `scripts/`).
- ✅ Актуальный список зависимостей: `requirements.txt` и `reports/requirements-optional.txt`.
- ✅ Архитектура соответствует реальным папкам `/src`, `/tests`, `/docs`, `/examples`, `/config`, `/data`, `/installer`, `/scripts`, `/docker`, `/notebooks`, `/reports`, `/assets`, `/colab`.
...
├── build.py                      # Сборка
├── launch.sh / launch.bat / launch.ps1  # Скрипты запуска
...
│   ├── REPORT.md                 # Отчёты
│   ├── basic_prompts.md          # Базовые промпты
│   ├── quickstart.md             # Быстрый старт
│   ├── usage.md                  # Использование
│   ├── skills.md                 # Навыки
│   ├── digital-immortality.md    # Философия
│   ├── quantum-governance.md     # Квантовое управление
│   ├── mkdocs.yml                # Конфигурация MkDocs
│   └── developer-guide / user-guide / philosophy/
│
├── scripts/                      # Утилиты и сборка
│   ├── health_check.py           # Проверка целостности модулей/конфигов/БД
│   ├── build_exe.py              # Сборка EXE
│   ├── setup_builder.py          # Настройка сборки
│   ├── db_init.py                # Инициализация БД
│   ├── setup_argos.nsi           # NSIS-инсталлятор
│   └── pyproject.toml            # Метаданные пакета
│
├── docker/                       # Docker-конфигурация
│   └── argos.service             # Systemd unit
│
├── notebooks/                    # Jupyter / Colab
│   └── argos_colab.ipynb         # Colab-ноутбук
│
├── reports/                      # Отчёты и опциональные зависимости
│   └── requirements-optional.txt # Опциональные зависимости
│
├── assets/                       # Иконки и статические ресурсы
│
├── config/                       # Конфигурации (DAG, шлюзы, промпты)
│
├── data/                         # База данных и модели
│
├── colab/                        # Colab-скрипты
│
