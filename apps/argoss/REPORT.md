...
| Тестовых файлов | **51** |
| Версий проекта | **3** (1.0.0-Absolute → 1.3.0 → 1.4.0) |
...
| **Промышленные** | KNX / LonWorks / M-Bus / OPC UA | ✅ Реализован (v1.4.0) |
...
### 4.9 Промышленные протоколы (v1.4.0)
...
### v1.4.0 (март 2026) — Промышленные протоколы
...
Ключевые Python-пакеты (из `pyproject.toml`, версия 1.4.0):
...
| Промышленные протоколы (KNX/LonWorks/M-Bus/OPC UA) | ✅ Реализован (v1.4.0) |
...
*Отчёт составлен автоматически на основании анализа кодовой базы репозитория `iliyaqdrwalqu/Argoss`, версия 1.4.0.*
